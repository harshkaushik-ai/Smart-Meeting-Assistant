    ...
    if(error){
        return(
            <div className='flex items-center justify-center min-h-screen bg-gray-900 text-white'>
                ...
                <p>{error}</p>
                <button onClick={()=>router.push("/")} className='mt-4 px-4 py-2  bg-red-500 rounded-lg hover:bg-red-600'>
                    Back
                </button>
                </div>
            </div>
    ...
    if(!token || !user){
        ...
        <div className='flex items-center justify-center  min-h-screen bg-gray-900 text-white'>
            <div className='text-center bg-gray-900'>
                <div className='animate-spin rounded-full h-16 w-16  border-t-4 border-blue-500 mx-auto bg-gray-900'></div>
